...
public class InfoScreenNemici extends AbstractGameScreen{
	...
	public InfoScreenNemici(DirectedGame game) {
		super(game);
	}
	...
	private Table buildLayerBackground() {
		...
		Image imgBackground = new Image(skinSuperMissile, "img_info_nemici");
	...
	private Table buildLayerAvanti() {
		...
		btnAvanti.addListener(new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				...
				game.setSchermo(new InfoScreenPotenziamenti(game), transizione);
			}
		});
		layer.add(btnAvanti);
